...
| 구분                | 기능 설명                                                                                                            |
|---------------------|-----------------------------------------------------------------------------------------------------------------------|
| **포스트/시리즈/댓글** | - 회원 별 스토리 페이지: 각 회원에게 개별 스토리 페이지를 제공<br>- 장르 별 베스트 게시글: 장르별로 베스트 게시글을 표시<br>- 시리즈 별 포스트 등록: 시리즈에 포스트를 등록할 수 있는 기능<br>- 포스트 작성 시 Toast-ui-editor 연동: 포스트 작성 시 Toast-ui-editor 사용<br>- 포스트 발행 옵션 (공개여부, 유료여부 등): 포스트 발행 시 공개 여부와 유료 여부 설정<br>- 댓글과 답 댓글 작성: 댓글 및 답 댓글 작성 기능<br>- 포스트 및 댓글 신고: 포스트 및 댓글 신고 기능 |
| **포인트충전/결제/정산** | - PotOne API를 활용한 포인트 충전 및 내역 조회: PotOne API를 통해 포인트 충전 및 내역 조회<br>- 정산 요청을 위한 계좌 정보 등록 및 검증 (PotOne API): PotOne API를 이용한 계좌 정보 등록 및 검증<br>- 포인트 거래를 통해 수익 적립: 포인트 거래를 통한 수익 적립<br>- 수익 정산 기능: 수익을 정산하는 기능               |
| **멤버십**             | - 회원 구독 기능: 회원 구독 기능 제공<br>- 멤버십 개설 및 가입: 멤버십 개설 및 가입 기능                                                             |
| **회원/좋아요**         | - Spring Security를 활용한 로그인, 회원가입: Spring Security를 이용한 로그인 및 회원가입<br>- 회원가입 시 메일 인증을 위해 인증 키 전송: 회원가입 시 메일 인증 키 전송<br>- 회원 및 시리즈, 포스트 썸네일 등록: 회원, 시리즈, 포스트 썸네일 등록 기능<br>- 포스트 좋아요 기능: 포스트에 좋아요 기능 제공 |
